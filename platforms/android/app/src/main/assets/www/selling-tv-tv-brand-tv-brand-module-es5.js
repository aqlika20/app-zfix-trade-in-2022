...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["selling-tv-tv-brand-tv-brand-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesLandingModalModalHarapDiperhatikanModalHarapDiperhatikanComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesLandingModalModalTvModalFormTvModalFormTvComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesLandingModalModalTvModalPriceTvModalPriceTvComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesLandingModalModalHarapDiperhatikanModalHarapDiperhatikanComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesLandingModalModalHarapDiperhatikanModalHarapDiperhatikanComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalHarapDiperhatikanComponent", function () {
      return ModalHarapDiperhatikanComponent;
    });
    /* harmony import */
    ...
    var ModalHarapDiperhatikanComponent = /*#__PURE__*/function () {
      function ModalHarapDiperhatikanComponent(ModalController, storage, utilsService) {
        _classCallCheck(this, ModalHarapDiperhatikanComponent);
      ...
      _createClass(ModalHarapDiperhatikanComponent, [{
        key: "ngOnInit",
    ...
    ModalHarapDiperhatikanComponent.ctorParameters = function () {
      return [{
    ...
    ModalHarapDiperhatikanComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-modal-harap-diperhatikan',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./modal-harap-diperhatikan.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/landing/modal/modal-harap-diperhatikan/modal-harap-diperhatikan.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./modal-harap-diperhatikan.component.scss */
      "./src/app/pages/landing/modal/modal-harap-diperhatikan/modal-harap-diperhatikan.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesLandingModalModalTvModalFormTvModalFormTvComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesLandingModalModalTvModalFormTvModalFormTvComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalFormTvComponent", function () {
      return ModalFormTvComponent;
    });
    /* harmony import */
    ...
    var src_app_pages_landing_modal_modal_tv_modal_price_tv_modal_price_tv_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/pages/landing/modal/modal-tv/modal-price-tv/modal-price-tv.component */
    "./src/app/pages/landing/modal/modal-tv/modal-price-tv/modal-price-tv.component.ts");

    var ModalFormTvComponent = /*#__PURE__*/function () {
      function ModalFormTvComponent(ModalController) {
        _classCallCheck(this, ModalFormTvComponent);

        this.ModalController = ModalController;
      }

      _createClass(ModalFormTvComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "dismissModal",
    ...
    ModalFormTvComponent.ctorParameters = function () {
      return [{
        type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]
      }];
    };

    ModalFormTvComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-modal-form-tv',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./modal-form-tv.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/landing/modal/modal-tv/modal-form-tv/modal-form-tv.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./modal-form-tv.component.scss */
      "./src/app/pages/landing/modal/modal-tv/modal-form-tv/modal-form-tv.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesLandingModalModalTvModalPriceTvModalPriceTvComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesLandingModalModalTvModalPriceTvModalPriceTvComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalPriceTvComponent", function () {
      return ModalPriceTvComponent;
    });
    /* harmony import */
    ...
    var ModalPriceTvComponent = /*#__PURE__*/function () {
      function ModalPriceTvComponent(ModalController, selling, router, storage, sellingApiService, activatedRoute, utilsService, localNotifications) {
        _classCallCheck(this, ModalPriceTvComponent);
      ...
      _createClass(ModalPriceTvComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        ...
        value: function getData() {
          ...
          this.storage.get(_config_api__WEBPACK_IMPORTED_MODULE_5__["tokenKey"]).then(function (token) {
            var data = {
              brand: _this.brand,
              jenis_tv: _this.jenis,
              inch: _this.inch,
              inner_screen: _this.inner_valueSelected,
              outer_screen: _this.outer_valueSelected,
              condition: _this.condition_valueSelected,
              addition: _this.addition_valueSelected
            };
            console.log(data);

            _this.sellingApiService.getTvDetail(token, data).subscribe(function (response) {
                  ...
                  case 0:
                    this.storage.get(_config_api__WEBPACK_IMPORTED_MODULE_5__["tokenKey"]).then(function (token) {
                      var data = {
                        ...
                        suara: _this2.suara,
                        kondisi_tv: _this2.kondisi_tv,
                        kondisi_layar: _this2.kondisi_layar,
                        inch: _this2.inch,
                        price: _this2.price
                      };

                      _this2.sellingApiService.sellTv(token, data).subscribe(function (success) {
    ...
    ModalPriceTvComponent.ctorParameters = function () {
      return [{
    ...
    ModalPriceTvComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-modal-price-tv',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./modal-price-tv.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/landing/modal/modal-tv/modal-price-tv/modal-price-tv.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./modal-price-tv.component.scss */
      "./src/app/pages/landing/modal/modal-tv/modal-price-tv/modal-price-tv.component.scss"))["default"]]
  ...
  function srcAppPagesLandingSellingTvTvBrandTvBrandPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_pages_landing_modal_modal_tv_modal_form_tv_modal_form_tv_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! src/app/pages/landing/modal/modal-tv/modal-form-tv/modal-form-tv.component */
    "./src/app/pages/landing/modal/modal-tv/modal-form-tv/modal-form-tv.component.ts");
    /* harmony import */
    ...
    var src_app_pages_landing_modal_modal_harap_diperhatikan_modal_harap_diperhatikan_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! src/app/pages/landing/modal/modal-harap-diperhatikan/modal-harap-diperhatikan.component */
    "./src/app/pages/landing/modal/modal-harap-diperhatikan/modal-harap-diperhatikan.component.ts");
    ...
    var TvBrandPage = /*#__PURE__*/function () {
      function TvBrandPage(membershipApiService, storage, sellingApiService, helper, device, utilsService, navCtrl, selling, router, activatedRoute, alertController, modalController) {
        ...
        this.data_jenis = [];
        this.stores = [];
        this.searchedStores = []; // selected_merk:string;
      ...
      _createClass(TvBrandPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.toggleKondisiTV(); // this.storage.get('Warning').then((result) => { 
          //   if(result){
          //   } else {
          //     this.Announcement();
          //   }
        ...
        key: "radioSelectLayar",
        value: function radioSelectLayar(event) {
          this.kondisi_layarSelected = event.detail.value;
        }
      }, {
        key: "radioSelectBody",
        value: function radioSelectBody(event) {
        ...
        key: "toggleOuterScreen",
        value: function toggleOuterScreen() {
        ...
        key: "toggleInnerScreen",
        value: function toggleInnerScreen() {
        ...
        key: "toggleKondisiTV",
        value: function toggleKondisiTV() {
        ...
        value: function getBrand() {
          ...
          this.storage.get(_config_api__WEBPACK_IMPORTED_MODULE_10__["tokenKey"]).then(function (token) {
            _this4.sellingApiService.getBrand(token).subscribe(function (response) {
              _this4.data_brand = response.data.brand;
              _this4.data_inch = response.data.inch;
              _this4.data_jenis = response.data.jenis_tv;
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 4:
                    if (!(this.kondisi_tvSelected == "Mati")) {
                      _context4.next = 13;
                      break;
                    }
